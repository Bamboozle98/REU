...
test_data = ts_data.flow_from_directory(directory="E:/My Data v.3/split_data/val",
                                        target_size=(224, 224))
...
prediction = Dense(103, activation='softmax')(x)  # Another FC layer with 103 nodes in reference to our # of classes. 
