...
train_data = tr_data.flow_from_directory(directory="E:/My Data v.3/split_data/train", target_size=(299, 299))
ts_data = ImageDataGenerator()
test_data = ts_data.flow_from_directory(directory="E:/My Data v.3/split_data/val", target_size=(299, 299))
